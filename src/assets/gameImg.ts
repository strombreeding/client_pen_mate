...
export const gameImg = {
  ...
  junkyard_ico_4: require("../assets/gameAssets/junkyard_ico_4-removebg-preview.png"),
  junkyard_ico_5: require("../assets/gameAssets/junkyard_ico_5-removebg-preview.png"),
  junkyard_ico_6: require("../assets/gameAssets/junkyard_ico_6-removebg-preview.png"),
  junkyard_ico_7: require("../assets/gameAssets/junkyard_ico_7-removebg-preview.png"),
  junkyard_ico_8: require("../assets/gameAssets/junkyard_ico_8-removebg-preview.png"),
  junkyard: require("../assets/gameAssets/junkyard.png"),
  sachunsung: require("../assets/gameAssets/sachunsung.png"),
